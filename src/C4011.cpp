...
nts::Tristate C4011::getValue() const
{
    return _value;
}

void C4011::NANDPin(int pin1, int pin2, int pin3)
{
    pin1--;
    pin2--;
    pin3--;
...
void C4011::simulate(int output)
{
    if (output != 0)
        return;
    NANDPin(1, 2, 3);
...
void C4011::setValue(const std::string &value)
{
    if (value == "0")
        _value = Tristate::FALSE;
    else if (value == "1")
